...
sections:
  ...
  - type: roi-calculator
    heading: "What would it cost for your operation?"
    perMinutePrice: 0.05
    currency: "€"

  - type: comparison-table
    kicker: "The model"
    heading: "Why per-minute"
    columns:
      - "Per-seat licensing"
      - "InOro per-minute"
    rows:
      ...
      - label: "Part-time & rotating agents"
        values: ["full seats anyway", "irrelevant — minutes are minutes"]
      - label: "Feature tiers"
  ...
  - type: faq
    ...
    items:
      ...
      - q: "Do you offer volume discounts?"
        a: "Pricing starts at €0.05/min; for high volumes, request a custom quote."
